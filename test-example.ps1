...
function Process-Project {
    ...
    Write-Output "`n--== Starting Vite React Bundling Project Processing ==--"

    # The project lives in the repository root
    $folderName = "devextreme-vite-react-bundling"
    $packages = @("devextreme", "devextreme-react")
    # build:devextreme-bundle must run first: it generates ./devextreme-bundle,
    # which App.jsx imports during the main build
    ...
    Write-Output "`n--== Vite React Bundling Project Processing Completed ==--"
}
